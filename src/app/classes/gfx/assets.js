...
const sprites = new Assets('sprites',  PATH + "sprites.png", SPRITE_WIDTH, 18);
//PLAYER
let framespeed = 200,
...
var idleframes = [
	...
	{frame: sprites.sheet.crop(1 * sprites.width, 2 * sprites.height, sprites.width, sprites.height),speed: framespeed},
